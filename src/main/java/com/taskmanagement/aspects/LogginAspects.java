...
public class LogginAspects {
    ...
    @AfterReturning(value = "com.taskmanagement.aspects.PointcutDefinitions.signupPointcut()",  returning = "result")
    ...
    @AfterReturning(value = "com.taskmanagement.aspects.PointcutDefinitions.signinPointcut()",  returning = "result")
